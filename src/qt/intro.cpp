...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("FotoCoin Core"),
     ...
     * override -datadir in the fotocoin.conf file in the default data directory
     * (to be consistent with fotocoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
