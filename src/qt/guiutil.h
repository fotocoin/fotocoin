...
/** Utility functions used by the FotoCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render FotoCoin addresses in monospace font
...
// Parse "FOTO:" URI into recipient object, return true on successful parsing
