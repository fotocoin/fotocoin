...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop FotoCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "FotoCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FotoCoin features */
        {"fotocoin", "masternode", &masternode, true, true, false},
        {"fotocoin", "masternodelist", &masternodelist, true, true, false},
        {"fotocoin", "mnbudget", &mnbudget, true, true, false},
        {"fotocoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"fotocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fotocoin", "mnsync", &mnsync, true, true, false},
        {"fotocoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"fotocoin", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use fotocoind, or the -server option to fotocoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> fotocoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:20755/\n";
}
