...
#if defined(NDEBUG)
#error "FotoCoin cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 0) {
		...
		nSubsidy = 2.15 * COIN;
	} else if (nHeight < 62000) {
		nSubsidy = 2.25 * COIN;
	} else if (nHeight < 72000) {
		nSubsidy = 2.5 * COIN;
	} else if (nHeight < 82000) {
		nSubsidy = 2.75 * COIN;
	} else if (nHeight < 92000) {
		nSubsidy = 3 * COIN;
	} else if (nHeight < 112000) {
		nSubsidy = 3.15 * COIN;
	} else if (nHeight < 142000) {
		nSubsidy = 3.25 * COIN;
...
{
    RenameThread("fotocoin-scriptch");
