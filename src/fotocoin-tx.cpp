...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("FotoCoin Core fotocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  fotocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded FotoCoin transaction") + "\n" +
                               "  fotocoin-tx [options] -create [commands]   " + _("Create hex-encoded FotoCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded FotoCoin transaction
