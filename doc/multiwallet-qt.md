...
In order to support loading of multiple wallets in fotocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fotocoin.cpp.
...
Changes to fotocoin.cpp
-------------------

fotocoin.cpp is the entry point into fotocoin-qt, and as such, will require some minor modifications to provide hooks for
