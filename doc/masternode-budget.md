...
FotoCoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare <proposal-name> <url> <payment_count> <block_start> <fotocoin_address> <monthly_payment_xmx>
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ FOTO, _12_ times over the course of a year totaling _24000_ FOTO.
...
mnbudget submit <proposal-name> <url> <payment_count> <block_start> <fotocoin_address> <monthly_payment_xmx> <collateral_hash>
...
When block `1000000` is reached you'll receive a payment for `1200` FOTO.
 ...
 * vote-many          - Vote on a FotoCoin initiative
 * vote-alias         - Vote on a FotoCoin initiative
 * vote               - Vote on a FotoCoin initiative/budget
