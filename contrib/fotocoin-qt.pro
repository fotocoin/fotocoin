...
RESOURCES += src/qt/fotocoin.qrc src/qt/fotocoin_locale.qrc

TRANSLATIONS += src/qt/locale/fotocoin_bg.ts \
                src/qt/locale/fotocoin_de.ts \
                src/qt/locale/fotocoin_en.ts \
                src/qt/locale/fotocoin_es.ts \
                src/qt/locale/fotocoin_fi.ts \
                src/qt/locale/fotocoin_fr.ts \
                src/qt/locale/fotocoin_it.ts \
                src/qt/locale/fotocoin_ja.ts \
                src/qt/locale/fotocoin_pl.ts \
                src/qt/locale/fotocoin_pt.ts \
                src/qt/locale/fotocoin_ru.ts \
                src/qt/locale/fotocoin_sk.ts \
                src/qt/locale/fotocoin_sv.ts \
                src/qt/locale/fotocoin_vi.ts \
                src/qt/locale/fotocoin_zh_CN.ts \
                src/qt/locale/fotocoin_zh_TW.ts